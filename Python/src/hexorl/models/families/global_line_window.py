"""Global line/window model family descriptor."""
...
from hexorl.models.trunks.global_line_window import GLOBAL_LINE_WINDOW_TRUNK, build_global_line_window_model

FAMILY_NAME = "global_line_window"
ALIASES = ("global_line_window_0",)
CAPABILITIES = CapabilitySet.of(
    (GLOBAL_GRAPH_INPUT, GLOBAL_PLACE_POLICY, PAIR_FIRST_POLICY, PAIR_SECOND_POLICY, JOINT_PAIR_POLICY, REGRET_HEAD)
)
COMPONENTS = FamilyComponents(trunk=GLOBAL_LINE_WINDOW_TRUNK, heads=(*GLOBAL_GRAPH_OUTPUT_HEADS, "opp_policy", "regret_rank", "regret_value", "moves_left", "tactical", "legal_token_quality", "lookahead_4", "lookahead_12", "lookahead_36"))
...
def descriptor() -> ModelFamilyDescriptor:
    return make_descriptor(
        ...
        builder=build_global_line_window_model,
