...
def _suite_trials(run_root: Path) -> list[dict[str, Any]]:
    ...
    for trial_dir in _suite_trial_dirs(run_root):
        ...
        row = {
            ...
            "graph_collate_s": latest_train.get("graph_collate_s") or latest_train.get("graph_loader_collate_s"),
            "dataloader_wait_s": latest_train.get("dataloader_wait_s"),
            "graph_loader_workers": latest_train.get("graph_loader_workers"),
            "graph_loader_prefetch_factor": latest_train.get("graph_loader_prefetch_factor"),
            "graph_snapshot_build_s": latest_train.get("graph_snapshot_build_s"),
            "graph_snapshot_records": latest_train.get("graph_snapshot_records"),
            "graph_loader_sample_s": latest_train.get("graph_loader_sample_s"),
            "graph_loader_graph_base_s": latest_train.get("graph_loader_graph_base_s"),
            "graph_loader_graph_cache_hits": latest_train.get("graph_loader_graph_cache_hits"),
            "graph_loader_graph_cache_misses": latest_train.get("graph_loader_graph_cache_misses"),
            "graph_loader_graph_parse_s": latest_train.get("graph_loader_graph_parse_s"),
            "graph_loader_graph_engine_s": latest_train.get("graph_loader_graph_engine_s"),
            "graph_loader_graph_oracle_s": latest_train.get("graph_loader_graph_oracle_s"),
            "graph_loader_graph_legal_rank_s": latest_train.get("graph_loader_graph_legal_rank_s"),
            "graph_loader_graph_active_windows_s": latest_train.get("graph_loader_graph_active_windows_s"),
            "graph_loader_graph_dev_stats_s": latest_train.get("graph_loader_graph_dev_stats_s"),
            "graph_loader_graph_tokens_s": latest_train.get("graph_loader_graph_tokens_s"),
            "graph_loader_graph_relations_s": latest_train.get("graph_loader_graph_relations_s"),
            "graph_loader_graph_targets_s": latest_train.get("graph_loader_graph_targets_s"),
            "graph_loader_policy_overlay_s": latest_train.get("graph_loader_policy_overlay_s"),
            "graph_loader_collate_s": latest_train.get("graph_loader_collate_s"),
            "graph_loader_untracked_s": latest_train.get("graph_loader_untracked_s"),
            "graph_relation_rebuild_s": latest_train.get("graph_relation_rebuild_s"),
            "graph_relation_sparse_edges": latest_train.get("graph_relation_sparse_edges"),
            "graph_relation_rebuild_workers": latest_train.get("graph_relation_rebuild_workers"),
